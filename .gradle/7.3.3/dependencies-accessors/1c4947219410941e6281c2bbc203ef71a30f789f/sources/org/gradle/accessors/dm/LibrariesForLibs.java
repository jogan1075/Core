...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers) {
        ...
        /**
         * Creates a dependency provider for androidLifecycleRuntimeKtx (androidx.lifecycle:lifecycle-runtime-ktx)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroidLifecycleRuntimeKtx() { return create("androidLifecycleRuntimeKtx"); }

        /**
         * Creates a dependency provider for composeLifecycleViewmodel (androidx.lifecycle:lifecycle-viewmodel-compose)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getComposeLifecycleViewmodel() { return create("composeLifecycleViewmodel"); }

        /**
         * Creates a dependency provider for composeRuntimeLivedata (androidx.compose.runtime:runtime-livedata)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getComposeRuntimeLivedata() { return create("composeRuntimeLivedata"); }
        ...
        /**
         * Creates a dependency provider for okttpInterceptor (com.squareup.okhttp3:logging-interceptor)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getOkttpInterceptor() { return create("okttpInterceptor"); }

        /**
         * Creates a dependency provider for preferenceKtx (androidx.preference:preference-ktx)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPreferenceKtx() { return create("preferenceKtx"); }
        ...
        /**
         * Creates a dependency provider for retrofitConverterGson (com.squareup.retrofit2:converter-gson)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRetrofitConverterGson() { return create("retrofitConverterGson"); }

        /**
         * Creates a dependency provider for retrofitConverterScalar (com.squareup.retrofit2:converter-scalars)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRetrofitConverterScalar() { return create("retrofitConverterScalar"); }

        /**
         * Creates a dependency provider for room (androidx.room:room-runtime)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRoom() { return create("room"); }
        ...
        /**
         * Creates a dependency provider for securityCryptoKtx (androidx.security:security-crypto-ktx)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSecurityCryptoKtx() { return create("securityCryptoKtx"); }
